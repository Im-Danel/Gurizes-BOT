...
module.exports = {
    ...
    .addStringOption(option => option.setName('hex').setDescription('Steam Hex membro que quer banir').setRequired(true))
    ...
    run: async (client, interaction) => {
       ...
       if(!hex) return interaction.followUp("😅 | Incapaz de encontrar detalhes do HEX mencionado.");
        
       connection.query(`UPDATE urca_users SET banned = '0' WHERE steam = '${hex}}'`, (err, rows) => { 
        const embed = new MessageEmbed()
        .setDescription(`🛑 | O Steam Hex **${hex}** Foi desbanido do servidor \nMotivo: \`${reason}\``)
        .setColor("#303136")
        .setTimestamp()
