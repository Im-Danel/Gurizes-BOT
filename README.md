...
Bot para Discord com comandos de prefixo e slash commands, incluindo integrações para FiveM, minigames e comandos utilitários.
...
Configure o arquivo `config.json` com seu token e credenciais antes de rodar.
